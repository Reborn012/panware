...
export declare function createMastraProxy({ mastra, logger }: {
    mastra: Mastra;
    logger: IMastraLogger;
}): Mastra<Record<string, import("./agent").Agent<any, ToolsInput, Record<string, import("./eval").Metric>>>, Record<string, import("./workflows/legacy").LegacyWorkflow<import("./workflows/legacy").LegacyStep<string, any, any, import("./workflows/legacy").StepExecutionContext<any, import("./workflows/legacy").WorkflowContext<any, import("./workflows/legacy").LegacyStep<string, any, any, any>[], Record<string, any>>>>[], string, any, any>>, Record<string, import("./workflows").Workflow<any, any, any, any, any, any>>, Record<string, import("./vector").MastraVector<import("./vector/filter").VectorFilter>>, Record<string, import("./tts").MastraTTS>, IMastraLogger, Record<string, import("./network/vNext").NewAgentNetwork>, Record<string, import("./mcp").MCPServerBase>, Record<string, import("./scores").MastraScorer<any, any, any, any>>>;
