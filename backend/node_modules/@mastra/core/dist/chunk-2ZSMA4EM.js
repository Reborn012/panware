...
import { MastraLLMV1 } from './chunk-TZZFP4EW.js';
import { MessageList, DefaultGeneratedFile, DefaultGeneratedFileWithType } from './chunk-SHFLPFKN.js';
import { executeHook } from './chunk-TTELJD4F.js';
import { zodToJsonSchema } from './chunk-PJKCPRYF.js';
import { getValidTraceId, wrapMastra, selectFields, getOrCreateSpan, ensureToolProperties, makeCoreTool, createMastraProxy, delay } from './chunk-SQFVIROI.js';
import { RuntimeContext } from './chunk-HLRWYUFN.js';
import { MastraError } from './chunk-MCOVMKIS.js';
import { ToolStream } from './chunk-A3QHQYMC.js';
import { Tool, createTool } from './chunk-AR76DMZQ.js';
...
var languageModelUsageSchema=z5.object({inputTokens:z5.number(),outputTokens:z5.number(),totalTokens:z5.number(),reasoningTokens:z5.number().optional(),cachedInputTokens:z5.number().optional()});var llmIterationStepResultSchema=z5.object({reason:z5.string(),warnings:z5.array(z5.any()),isContinued:z5.boolean(),logprobs:z5.any().optional(),totalUsage:languageModelUsageSchema.optional(),headers:z5.record(z5.string()).optional(),messageId:z5.string().optional(),request:z5.record(z5.any()).optional()});var llmIterationOutputSchema=z5.object({messageId:z5.string(),messages:z5.object({all:z5.array(z5.any()),// ModelMessage[] but too complex to validate at runtime
user:z5.array(z5.any()),nonUser:z5.array(z5.any())}),output:z5.object({text:z5.string().optional(),reasoning:z5.array(z5.any()).optional(),reasoningText:z5.string().optional(),files:z5.array(z5.any()).optional(),// GeneratedFile[]
toolCalls:z5.array(z5.any()).optional(),// TypedToolCall[]
toolResults:z5.array(z5.any()).optional(),// TypedToolResult[]
sources:z5.array(z5.any()).optional(),// LanguageModelV2Source[]
staticToolCalls:z5.array(z5.any()).optional(),dynamicToolCalls:z5.array(z5.any()).optional(),staticToolResults:z5.array(z5.any()).optional(),dynamicToolResults:z5.array(z5.any()).optional(),usage:languageModelUsageSchema,steps:z5.array(z5.any())// StepResult[]
}),metadata:z5.object({id:z5.string().optional(),model:z5.string().optional(),modelId:z5.string().optional(),timestamp:z5.date().optional(),providerMetadata:z5.record(z5.any()).optional(),headers:z5.record(z5.string()).optional(),request:z5.record(z5.any()).optional()}),stepResult:llmIterationStepResultSchema});var toolCallInputSchema=z5.object({toolCallId:z5.string(),toolName:z5.string(),args:z5.record(z5.any()),providerMetadata:z5.record(z5.any()).optional(),providerExecuted:z5.boolean().optional(),output:z5.any().optional()});var toolCallOutputSchema=toolCallInputSchema.extend({result:z5.any(),error:z5.any().optional()});// src/loop/workflows/agentic-execution/llm-execution-step.ts
...
function createStreamStep({capabilities,runId,returnScorerData,format="mastra",requireToolApproval,resumeContext}){return createStep({id:"stream-text-step",inputSchema:z.any(),// tried to type this in various ways but it's too complex
...
//# sourceMappingURL=chunk-2ZSMA4EM.js.map
//# sourceMappingURL=chunk-2ZSMA4EM.js.map