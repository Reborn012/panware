...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    const workflowSteps = this.steps.map((scorerStep) => {
      return chunkCBV6EVJK_cjs.createStep({
        id: scorerStep.name,
    ...
    const workflow = chunkCBV6EVJK_cjs.createWorkflow({
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const judge = new chunkCBV6EVJK_cjs.Agent({
      name: "judge",
      model,
      instructions,
...
function isWorkflow(target) {
  return target instanceof chunkCBV6EVJK_cjs.Workflow;
}
...
//# sourceMappingURL=chunk-TJZ4ERV4.cjs.map
//# sourceMappingURL=chunk-TJZ4ERV4.cjs.map