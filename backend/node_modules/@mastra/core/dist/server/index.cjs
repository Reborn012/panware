...
_MastraAuthProvider_decorators = [chunkTKFLL33F_cjs.InstrumentClass({
  prefix: "auth",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "#log"]
})];
exports.MastraAuthProvider = class MastraAuthProvider extends (_a = chunk4L3P3PCP_cjs.MastraBase) {
  constructor(options) {
    super({
      component: "AUTH",
      name: options?.name
