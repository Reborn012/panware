...
export declare class DefaultExecutionEngine extends ExecutionEngine {
    ...
    executeStep({ workflowId, runId, resourceId, step, stepResults, executionContext, resume, prevOutput, emitter, abortController, runtimeContext, skipEmits, writableStream, disableScorers, serializedStepGraph, tracingContext, }: {
        workflowId: string;
        runId: string;
        resourceId?: string;
