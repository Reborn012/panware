...
var CoreToolBuilder = class extends chunk4L3P3PCP_cjs.MastraBase {
  ...
  getParameters = () => {
    if (chunkOVVKYARB_cjs.isVercelTool(this.originalTool)) {
  ...
  createExecute(tool, options, logType) {
    ...
    const execFunction = async (args, execOptions) => {
      ...
      try {
        let result;
        if (chunkOVVKYARB_cjs.isVercelTool(tool)) {
    ...
    return async (args, execOptions) => {
      ...
      try {
        ...
        const parameters = this.getParameters();
        const { data, error: error2 } = chunkOVVKYARB_cjs.validateToolInput(parameters, args, options.name);
        if (error2) {
...
//# sourceMappingURL=chunk-GGN63GU5.cjs.map
//# sourceMappingURL=chunk-GGN63GU5.cjs.map