...
var NewAgentNetwork = class extends chunk4L3P3PCP_cjs.MastraBase {
  ...
  async beforeRun({
    ...
    if (typeof messages === "string") {
      ...
      const messageList = new chunkL7Z3C5XG_cjs.MessageList({
        threadId: thread?.id,
        resourceId: thread?.resourceId
      });
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkCBV6EVJK_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(messages, {
    ...
    const finalStep = chunkCBV6EVJK_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunkCBV6EVJK_cjs.createWorkflow({
      id: "Agent-Network-Main-Workflow",
      inputSchema: zod.z.object({
        iteration: zod.z.number(),
        task: zod.z.string(),
        resourceType: chunkCBV6EVJK_cjs.RESOURCE_TYPES,
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunkCBV6EVJK_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunkCBV6EVJK_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const workflowStep = chunkCBV6EVJK_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunkCBV6EVJK_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunkCBV6EVJK_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunkCBV6EVJK_cjs.createWorkflow({
