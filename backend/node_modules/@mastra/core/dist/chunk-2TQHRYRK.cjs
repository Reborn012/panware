...
_MastraTTS_decorators = [chunkTKFLL33F_cjs.InstrumentClass({
  prefix: "tts",
  excludeMethods: ["__setTools", "__setLogger", "__setTelemetry", "#log"]
})];
exports.MastraTTS = class MastraTTS extends (_a = chunk4L3P3PCP_cjs.MastraBase) {
  model;
  constructor({
    model
  }) {
...
//# sourceMappingURL=chunk-2TQHRYRK.cjs.map
//# sourceMappingURL=chunk-2TQHRYRK.cjs.map