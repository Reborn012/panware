...
export declare class MastraAgentNetworkStream extends ReadableStream<ChunkType> {
    ...
    get result(): Promise<import("..").WorkflowResult<import("zod").ZodType<any, import("zod").ZodTypeDef, any>, import("zod").ZodType<any, import("zod").ZodTypeDef, any>, import("..").Step<string, any, any, any, any, any>[]> | undefined>;
    get usage(): Promise<{
        inputTokens: number;
        outputTokens: number;
        totalTokens: number;
